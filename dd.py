...
SECTORS = {
    ...
    "FMCG": [
        ...
        "BIKAJI-EQ", "VBL-EQ", "ETERNAL-EQ", "DOMS-EQ", "ZYDUSWELL-EQ", "ABDL-EQ",
    ...
    "Capital Goods": [
        ...
        "POWERMECH-EQ", "ISGEC-EQ", "DYNAMATECH-EQ", "MARINE-EQ", "SKIPPER-EQ",
    ...
    "Chemicals": [
        ...
        "SUMICHEM-EQ", "PIIND-EQ", "EIDPARRY-EQ", "CHEMPLASTS-EQ", "TATVA-EQ",
        "IGPL-EQ", "TIRUMALCHM-EQ", "RALLIS-EQ"
    ],
    "Telecom": [
        "BHARTIARTL-EQ", "INDUSTOWER-EQ", "TATACOMM-EQ",
        "HFCL-EQ", "TEJASNET-EQ", "STLTECH-EQ"
    ],
    "Infrastructure": [
