...
SECTORS = {
    ...
    "Auto": [
        ...
        "HINDMOTORS-EQ", "MAHSCOOTER-EQ", "SONACOMS-EQ", "CRAFTSMAN-EQ"
    ],
    "Pharma": [
    ...
    "Infrastructure": [
        ...
        "ASHOKA-EQ", "JWL-EQ", "KALPATPOWR-EQ",
        "IRCON-EQ", "ENGINERSIN-EQ", "AHLUWALIA-EQ", "PSPPROJECTS-EQ", "CAPACITE-EQ",
        "WELSPUNIND-EQ", "MANINFRA-EQ", "ADANIPORTS-EQ", "JSWINFRA-EQ"
    ],
    "Insurance": [
    ...
    "Consumer Services": [
        "ZOMATO-EQ", "NYKAA-EQ", "ADANIPORTS-EQ", "IRCTC-EQ", "PAYTM-EQ", "INDHOTEL-EQ", "NAUKRI-EQ", "DELHIVERY-EQ",
